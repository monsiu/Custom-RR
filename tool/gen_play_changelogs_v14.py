#!/usr/bin/env python3
"""Write v1.3.4 (versionCode 14) Play release notes into every locale's
changelogs/14.txt.
...
EN_LINES = [
    "Infinix, Itel and Tecno pages now point to the HOVATEK forum, its firmware and TWRP builder tools, and the Treble GSI tab, since these brands rarely get a dedicated custom ROM.",
    "Added an unsigned iOS build for AltStore and TrollStore, plus cleaner, flatter card styling.",
]
...
MANUAL_LANG_LINES = {
    "rm": [
        "Las paginas d'Infinix, Itel e Tecno renvieschan ussa al forum HOVATEK, a ses utensils da firmware e TWRP builder, ed a la tab Treble GSI, damai che questas marcas survegnan darar in custom ROM agen.",
        "Agiuntà ina versiun iOS betg signada per AltStore e TrollStore, plus in stil da cartas pli net e plat.",
    ],
}
