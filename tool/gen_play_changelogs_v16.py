#!/usr/bin/env python3
"""Write v1.3.6 (versionCode 16) Play release notes into every locale's
changelogs/16.txt.

Same locale-coverage model as prior releases: English locales reuse the
canonical English note, others are translated at generation time. Files are
written without a trailing newline and each stays under 500 code points.
"""
...
EN_LINES = [
    "The app now finds more phones automatically, including regional models and devices that share one family build.",
    "After the app helps you reach a download, you can now rate the app in a quick prompt, and from the menu.",
]
...
MANUAL_LANG_LINES = {
    "rm": [
        "L'app chatta ussa automaticamain dapli telefons, era models regiunals ed apparats che partan in build da famiglia.",
        "Suenter che l'app ta gida ad arrivar tar in download, pos ti ussa valitar l'app en in dumond svelt, e dal menu.",
    ],
}
