#!/usr/bin/env python3
"""Write v1.3.5 (versionCode 15) Play release notes into every locale's
changelogs/15.txt.
...
EN_LINES = [
    "When your phone is not in the catalog, the app now helps you find unofficial ROMs, recoveries and GSI guides for it on XDA and from the community.",
]
...
MANUAL_LANG_LINES = {
    "rm": [
        "Sche voss telefon n'è betg en il catalog, l'app gida ussa a chattar ROM, recuperaziuns e guidas GSI betg uffizialas per el, sin XDA e da la communitad.",
    ],
}
