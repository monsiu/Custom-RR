#!/usr/bin/env python3
"""Write v1.3.3 (versionCode 13) Play release notes into every locale's
changelogs/13.txt.
...
EN_LINES = [
    "Flash script guides now match your phone brand, with the right unlock and flashing steps for Samsung, Xiaomi, Motorola, Sony, realme and OPPO.",
    "Added an option to rate the app and GitHub Sponsors support, and sharing now opens the Google Play listing.",
]
...
MANUAL_LANG_LINES = {
    "rm": [
        "Las guidas dal script da flash correspundan ussa a la marca da voss telefon, cun ils dretgs pass per debloccar e flashar Samsung, Xiaomi, Motorola, Sony, realme ed OPPO.",
        "Agiuntà ina opziun per valitar l'app e sustegn da GitHub Sponsors, e la cundivisiun avra ussa la pagina da Google Play.",
    ],
}
